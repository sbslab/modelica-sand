within SandStorage.BaseClasses;
model Boundary_pT_highP
...
initial equation
  if not use_p_in then
    ...
    if checkAirPressure then
      assert(p_in_internal>5e4 and p_in_internal < 1.5e6, "In "+getInstanceName() +
...
<ul>
<li>
December 16, 2022, by Kathryn Hinkelman:<br/>
Reimplementation of <a href=\"modelica://Buildings.Fluid.Sources.Boundary_pT\">
Buildings.Fluid.Sources.Boundary_pT</a> with a revised high pressure limit.
</li>
</ul>
</html>"),
    Icon(graphics={
